<nav class="bg-gray-800" x-data="{ isOpen: false }" class="relative ...">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <div>
                    ...
                    <img class="h-8 w-8 rounded-full" src="{{ asset('img/erika.jpg') }}" alt="">
                    </button>
                </div>
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <div class="flex-shrink-0">
                <img class="h-10 w-10 rounded-full" src="{{ asset('img/erika.jpg') }}" alt="">
            </div>
            <div class="ml-3">
                <div class="text-base font-medium leading-none text-white">Erika Kathrina</div>
                <div class="text-sm font-medium leading-none text-gray-400">winterheatherica@gmail.com</div>
            </div>
            </div>
