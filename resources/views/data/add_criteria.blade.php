                ...
                <tbody>
                    <tr class="bg-gray-500 text-white text-sm border text-center">
                        ...
                        <td class="border px-4 py-2">
                            <input type="text" name="criteria_name" class="text-black px-2 py-1 rounded-md" required>
                        </td>
                    </tr>
                    <tr class="bg-gray-500 text-white text-sm border text-center">
                        <td class="border px-4 py-2">Criteria Status</td>
                        <td class="border px-4 py-2">
                            <label>
                                <input type="radio" name="criteria_status" value="b" required> Benefit
                            </label>
                            <label class="ml-4">
                                <input type="radio" name="criteria_status" value="c" required> Cost
                            </label>
                        </td>
                    </tr>
                </tbody>
